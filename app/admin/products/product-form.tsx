...
const productDefaultValues: IProductInput =
    process.env.NODE_ENV === 'development'
        ? {
            ...
            images: [], // Pastikan tidak ada gambar default
            brand: 'Sample Brand',
    ...
    return (
        <Form {...form}>
            <form method="post" onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                            ...
                            <FormItem className="w-full">
                                ...
                                <FormControl>
                                    <div className="relative">
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => form.setValue('slug', toSlug(form.getValues('name')))}
                ...
                {/* List Price, Price & Count In Stock Fields */}
                <div className="flex flex-col gap-5 md:flex-row">
                    <FormField
                        control={form.control}
                        name="listPrice"
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className="w-full">
                                ...
                                <FormControl>
                                    <Input type="number" placeholder="Enter product count in stock" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
